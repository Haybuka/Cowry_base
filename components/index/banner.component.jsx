    ...
    <section className="grid grid-cols-1 lg:grid-cols-2">
      ...
      <aside className=" bg-base_highlight_bg flex justify-center items-center p-[60px]">
        <div className="img-container w-[250px] md:w-[400px] relative">
          <img src="./images/index/iPhone14.svg" className="w-full h-full relative z-30" />
          <img src="./images/index/ellipse1.svg" className="absolute -right-2 -bottom-2 z-10" />
          <img src="./images/index/ellipse2.svg" className="absolute -right-10 -bottom-10 " />
          <img src="./images/index/bgdot.svg" className="absolute top-[30px] -left-[120px]" />
