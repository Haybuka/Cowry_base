...
const Banner = () => {
  return (
    <section className="grid grid-cols-1 lg:grid-cols-2 md:py-0">
      <article className="flex justify-center items-center py-10 p-[20px] md:p-[80px] w-full">
      ...
      <aside className=" bg-base_highlight_bg flex justify-center items-center p-[60px] md:p-[70px]">
        <div className="img-container w-[200px] md:w-[250px] lg:w-[300px] relative">
